...
%
function [W1out, W2out, b1out, b2out, ave2] = Mbptans1e(W1,W2,b1,b2,alp,PP,TT, gamma)

[rp, cp] = size(PP);

ave2 = 0;

%keeps track of the delta for backpropagation
for q = 1:cp;
    if q == 1
        [W1new, W2new, b1new, b2new, avge2, W2_ndelta, W1_ndelta, b2_ndelta, b1_ndelta] = Mbptans1pat(W1,W2,b1,b2,alp,PP(:,q),TT(:,q), gamma, 0, 0, 0, 0);
        W2_delta = W2_ndelta;
        b2_delta = b2_ndelta;
        W1_delta = W1_ndelta;
        b1_delta = b1_ndelta;
        ...
        [W1new, W2new, b1new, b2new, avge2, W2_ndelta, W1_ndelta, b2_ndelta, b1_ndelta] = Mbptans1pat(W1,W2,b1,b2,alp,PP(:,q),TT(:,q), gamma, W2_delta, W1_delta, b2_delta, b1_delta);
        W2_delta = W2_ndelta;
        b2_delta = b2_ndelta;
        W1_delta = W1_ndelta;
        b1_delta = b1_ndelta;
