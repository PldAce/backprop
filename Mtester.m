function Mtester(W1, W2, b1,b2, alp, PP, TT)
%TESTER Trains  
...
gamma = 0.9;               %gamma for backpropagation
maxEP = 3000;            % Number of epochs
...
for en = 1:maxEP
       [W1new, W2new, b1new, b2new, ave2] = Mbptans1e(W1,W2,b1,b2,alp,PP,TT,gamma);       
